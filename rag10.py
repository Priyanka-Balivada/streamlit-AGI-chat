...
parameters["milvusTextKey"] = st.sidebar.text_input("Text Key", value="text")
...
if st.button("Ask"):
    if query_str:
        ...
        from llama_index.llms.huggingface import HuggingFaceLLM  # Example for TGI integration

        # Initialize the HuggingFace LLM (TGI)
        llm = HuggingFaceLLM(
            model_name="openai-community/gpt2",  # Replace with your TGI model's name
            # server_url="http://localhost:8084/",  # URL of your TGI server
