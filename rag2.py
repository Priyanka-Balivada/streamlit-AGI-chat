...
query_str = "Can you give me HuggingFace?"
...
vector_store = MilvusVectorStore(
    ...
    overwrite=False,
    collection_name="app_new_milvus_db",
...
#     def __init__(self, model_name, base_url, temperature, max_tokens, max_length, top_k, top_p, repetition_penalty, num_return_sequences):
...
#         # Define the URL for the text generation API
...
# # Example of how to use the TextGenerationInference class

# llm = TextGenerationInference(
#     model_name="openai-community/gpt2",  # Replace with your model if different
